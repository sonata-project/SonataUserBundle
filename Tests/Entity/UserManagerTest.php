    ...
    public function testGetPagerWithValidSortDesc()
    {
        ...
        $this
            ->getUserManager(function ($qb) use ($self) {
                ...
                $qb->expects($self->never())->method('setParameter')->with(
                ...
                $qb->expects($self->once())->method('setParameters')->with(
                    $self->equalTo(array('enabled' => true))
                );
            })
        ...
        $this
            ->getUserManager(function ($qb) use ($self) {
                ...
                $qb->expects($self->once())->method('setParameters')->with($self->equalTo(
                    array('enabled' => false, 'locked' => false)
                ));
                $qb->expects($self->once())->method('orderBy')->with(
                    $self->equalTo('u.username'),
                    $self->equalTo('ASC')
    ...
    public function testGetPagerWithEnabledAndNonLockedUsers()
    {
        ...
        $this
            ->getUserManager(function ($qb) use ($self) {
                ...
                $qb->expects($self->once())->method('setParameters')->with($self->equalTo(
                    array('enabled' => true, 'locked' => false)
                ));
                $qb->expects($self->once())->method('orderBy')->with(
                    $self->equalTo('u.username'),
                    $self->equalTo('ASC')
    ...
    public function testGetPagerWithEnabledAndLockedUsers()
    {
        ...
        $this
            ->getUserManager(function ($qb) use ($self) {
                ...
                $qb->expects($self->once())->method('setParameters')->with($self->equalTo(
                    array('enabled' => true, 'locked' => true)
                ));
                $qb->expects($self->once())->method('orderBy')->with(
                    $self->equalTo('u.username'),
                    $self->equalTo('ASC')
    ...
    public function testGetPagerWithDisabledAndLockedUsers()
    {
        ...
        $this
            ->getUserManager(function ($qb) use ($self) {
                ...
                $qb->expects($self->once())->method('setParameters')->with($self->equalTo(
                    array('enabled' => false, 'locked' => true)
                ));
                $qb->expects($self->once())->method('orderBy')->with(
                    $self->equalTo('u.username'),
                    $self->equalTo('ASC')
