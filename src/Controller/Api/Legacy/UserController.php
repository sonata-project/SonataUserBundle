...
@trigger_error(
    'The '.__NAMESPACE__.'\UserController class is deprecated since sonata-project/user-bundle 4.x and will be removed in version 5.0.'
    .' Use '.\Sonata\UserBundle\Controller\Api\UserController::class.' instead.',
    E_USER_DEPRECATED
);
...
final class UserController
{
     ...
     * )
     *
     * @REST\QueryParam(name="page", requirements="\d+", default="1", description="Page for users list pagination (1-indexed)")
     * @REST\QueryParam(name="count", requirements="\d+", default="10", description="Number of users by page")
     * @REST\QueryParam(name="orderBy", map=true, requirements="ASC|DESC", nullable=true, strict=true, description="Query users order by clause (key is field, value is direction")
     * @REST\QueryParam(name="enabled", requirements="0|1", nullable=true, strict=true, description="Enabled/disabled users only?")
     *
     ...
     * @throws NotFoundHttpException
     */
    private function getUser($id): UserInterface
    {
     ...
     */
    private function handleWriteUser(Request $request, $id = null): FormInterface
    {
