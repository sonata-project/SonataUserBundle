    ...
    protected function configureFormFields(FormMapper $formMapper): void
    {
        ...
        $formMapper
            ->tab('User')
                ...
                ->end()
                ->with('Social')
                    ->add('facebookUid', TextType::class, ['required' => false])
                    ->add('facebookName', TextType::class, ['required' => false])
                    ->add('twitterUid', TextType::class, ['required' => false])
                    ->add('twitterName', TextType::class, ['required' => false])
                    ->add('gplusUid', TextType::class, ['required' => false])
                    ->add('gplusName', TextType::class, ['required' => false])
                ->end()
            ->end()
            ->tab('Security')
                ->with('Status')
