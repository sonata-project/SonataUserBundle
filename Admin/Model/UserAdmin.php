        ...
        $formMapper
            ->tab('User')
                ...
                ->with('Profile')
                    ...
                    ->add('firstname', $textType, ['required' => false])
                    ->add('lastname', $textType, ['required' => false])
                ...
                ->end()
                ->with('Social')
                    ->add('facebookUid', $textType, ['required' => false])
                    ->add('facebookName', $textType, ['required' => false])
                    ->add('twitterUid', $textType, ['required' => false])
                    ->add('twitterName', $textType, ['required' => false])
                    ->add('gplusUid', $textType, ['required' => false])
                    ->add('gplusName', $textType, ['required' => false])
                ->end()
            ->end()
            ->tab('Security')
                ->with('Status')
