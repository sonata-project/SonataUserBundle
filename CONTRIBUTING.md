...
-------------------- | ------------------------ | --------------- | ----------------------- | ----- |
Bug fixes            | Yes                      | Patch           | `5.x`   |       |
Bug fixes            | No (Only if no choice)   | Major           | `6.x` |       |
Feature              | Yes                      | Minor           | `5.x`   |       |
Feature              | No (Only if no choice)   | Major           | `6.x` |       |
Deprecation          | Yes (Have to)            | Minor           | `5.x`   |       |
Deprecation removal  | No (Can't be)            | Major           | `6.x` |       |

Notes:
  * Branch `5.x` is the branch of the **latest stable** minor release and
  ...
  * If you PR is not **Backward Compatible** but can be, it **MUST** be:
    ...
    * If your BC PR is accepted, you can do a new one on the `6.x` branch which removes the deprecated code.
