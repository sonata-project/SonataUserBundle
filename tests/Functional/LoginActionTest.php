...
namespace Sonata\UserBundle\Tests\Functional;
...
class LoginActionTest extends WebTestCase
{
    public function testItSubmitsLoginForm(): void
    {
        ...
        $this->prepareData('username', 'email@localhost');
    ...
    public function testItSubmitsLoginFormWithDisabledUser(): void
    {
        ...
        $this->prepareData('username_disabled', 'email_disabled@localhost', false);
        ...
        $client->submitForm('submit', [
            '_username' => 'email_disabled@localhost',
            '_password' => 'random_password',
        ]);
        $client->followRedirect();
    ...
    private function prepareData(string $username, string $email, bool $enabled = true): void
    {
